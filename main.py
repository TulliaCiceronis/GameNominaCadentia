...
schrift = pygame.font.SysFont("futura", 17)
schrift2 = pygame.font.SysFont("futura", 100)
schrift3 = pygame.font.SysFont("futura", 50)
schrift4 = pygame.font.SysFont("futura", 17, True)
schrift5 = pygame.font.SysFont("futura", 10)
...
def loss(dekl, farbe):
    ...
    if hit <= -5:
        ...
        if punkte >= highscore:
            ...
            screen.blit(gewinn, (100, 190))
            gewinn1 = schrift2.render("highscore!", True, farbe)
            screen.blit(gewinn1, (120, 280))
            user_text = ""
            highscore = punkte
